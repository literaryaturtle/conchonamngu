            ...
            function(Level)
                ...
                if os.time() - LastTravel > 60 then
                    ...
                    if PlayerLevel >= 1500 and SeaIndex == 2 then
                        if Config.Settings.StayInSea2UntilHaveDarkFragments and
                ...
                if
                    PlayerLevel >= 2025 and
                        ...
                        (ScriptStorage.Backpack.Bones or {Count = 0}).Count < 500 and not ScriptStorage.Melees['Dragon Talon']
                 then
